...
public class JsonMocker {
    ...
    private RanOpt[] osOpts = {new RanOpt("ios", 3), new
            RanOpt("andriod", 7)};
    ...
    private RanOpt[] areaOpts = {new RanOpt("beijing", 10),
            ...
            new RanOpt("hebei", 5), new RanOpt("heilongjiang", 5),
            new RanOpt("shandong", 5), new RanOpt("tianjin", 5),
            new RanOpt("shan3xi", 5), new RanOpt("shan1xi", 5),
            new RanOpt("sichuan", 5)};
    private RandomOptionGroup<String> areaOptionGroup = new RandomOptionGroup(areaOpts);

    private String appId = "gmall0826";

    private RanOpt[] vsOpts = {new RanOpt("1.2.0", 50), new
            RanOpt("1.1.2", 15), new RanOpt("1.1.3", 30),
            new RanOpt("1.1.1", 5)};
    ...
    private RanOpt[] eventOpts = {new RanOpt("addFavor", 10), new
            RanOpt("addComment", 30), new RanOpt("addCart", 20),
            new RanOpt("clickItem", 40), new RanOpt("coupon", 45)};

    private RandomOptionGroup<String> eventOptionGroup = new RandomOptionGroup(eventOpts);

    private RanOpt[] channelOpts = {new RanOpt("xioami", 10), new
            RanOpt("huawei", 20), new RanOpt("wandoujia", 30),
            new RanOpt("360", 20), new RanOpt("tencent", 20),
    ...
    private RanOpt[] quitOpts = {new RanOpt(true, 20), new
            RanOpt(false, 80)};
    ...
    public JsonMocker(String startTimeString, String endTimeString, int startupNum,
                      int eventNum) {
        try {
        ...
        RandomDate logDateUtil = new RandomDate(startTime, endTime, startupNum + eventNum);
    }
